...
async function adminLogin(username, password) {
    const res = await fetch("".concat(API_BASE_URL, "/admin/auth/login"), {
        method: "POST",
        headers: {
...
function AdminHeader(param) {
    ...
    function handleLogout() {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$admin$2d$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["adminLogout"])();
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    ...
                                    children: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$admin$2d$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ADMIN_ROLE_LABELS"][admin.role]
                                }, void 0, false, {
                                    fileName: "[project]/components/admin-header.tsx",
                                    lineNumber: 33,
                                    columnNumber: 13
...
"[project]/lib/use-admin-guard.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useAdminGuard() {
    _s();
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const [admin, setAdmin] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(undefined);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useAdminGuard.useEffect": ()=>{
            const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$admin$2d$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAdminToken"])();
            const info = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$admin$2d$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAdminInfo"])();
            if (!token || !info) {
...
_s(useAdminGuard, "kTqM+RHN8bg/lSaiz1C/H67AIfU=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
"[project]/lib/admin-api.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function fetchOperators() {
    const res = await fetch("".concat(API_BASE_URL, "/admin/operators"), {
        headers: authHeaders()
    });
...
async function setOperatorActive(id, active) {
    const res = await fetch("".concat(API_BASE_URL, "/admin/operators/").concat(id, "/active"), {
        method: "PATCH",
        headers: authHeaders(),
        body: JSON.stringify({
            active
...
async function fetchChangeRequests(opts) {
    ...
    const res = await fetch("".concat(API_BASE_URL, "/admin/change-requests?").concat(params.toString()), {
        headers: authHeaders()
    });
...
async function fetchChangeRequestDetail(id) {
    const res = await fetch("".concat(API_BASE_URL, "/admin/change-requests/").concat(id), {
        headers: authHeaders()
    });
...
async function approveChangeRequest(id, notes) {
    const res = await fetch("".concat(API_BASE_URL, "/admin/change-requests/").concat(id, "/approve"), {
        method: "POST",
        headers: authHeaders(),
        body: JSON.stringify({
            notes
...
async function rejectChangeRequest(id, notes) {
    const res = await fetch("".concat(API_BASE_URL, "/admin/change-requests/").concat(id, "/reject"), {
        method: "POST",
        headers: authHeaders(),
        body: JSON.stringify({
            notes
...
async function bulkGenerateDemandNotices() {
    const res = await fetch("".concat(API_BASE_URL, "/admin/demand-notices/bulk-generate"), {
        method: "POST",
        headers: authHeaders()
    });
    if (!res.ok) {
...
async function bulkRegenerateTaxHistory() {
    const res = await fetch("".concat(API_BASE_URL, "/admin/tax-history/bulk-regenerate"), {
        method: "POST",
        headers: authHeaders()
    });
    if (!res.ok) {
...
async function downloadExport(dataset) {
    const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$admin$2d$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAdminToken"])();
    if (!token) throw new Error("Not logged in — please log in again.");
    const res = await fetch("".concat(API_BASE_URL, "/admin/export?dataset=").concat(dataset), {
        headers: {
            Authorization: "Bearer ".concat(token)
        }
    });
    ...
    a.href = url;
    a.download = "nnm-export-".concat(dataset, "-").concat(new Date().toISOString().slice(0, 10), ".xlsx");
...
async function fetchDashboardSummaryAdmin() {
    const res = await fetch("".concat(API_BASE_URL, "/dashboard-summary"), {
        headers: authHeaders()
    });
...
async function fetchDashboardListAdmin(path, page, pageSize) {
    const res = await fetch("".concat(API_BASE_URL, "/dashboard-summary/").concat(path, "?page=").concat(page, "&pageSize=").concat(pageSize), {
        headers: authHeaders()
    });
...
"[project]/lib/admin-shop-api.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function fetchShopAgreementRequests(opts) {
    ...
    if (opts.status) params.set("status", opts.status);
    if (opts.myStage) params.set("myStage", "true");
    const res = await fetch("".concat(API_BASE_URL, "/admin/shop-agreement-requests?").concat(params.toString()), {
        headers: authHeaders()
    });
...
async function fetchShopAgreementRequestDetail(id) {
    const res = await fetch("".concat(API_BASE_URL, "/admin/shop-agreement-requests/").concat(id), {
        headers: authHeaders()
    });
...
async function approveShopAgreementRequest(id, notes) {
    const res = await fetch("".concat(API_BASE_URL, "/admin/shop-agreement-requests/").concat(id, "/approve"), {
        method: "POST",
        headers: authHeaders(),
        body: JSON.stringify({
            notes
...
async function rejectShopAgreementRequest(id, notes) {
    const res = await fetch("".concat(API_BASE_URL, "/admin/shop-agreement-requests/").concat(id, "/reject"), {
        method: "POST",
        headers: authHeaders(),
        body: JSON.stringify({
            notes
...
async function fetchRentalApplications(opts) {
    ...
    if (opts.status) params.set("status", opts.status);
    if (opts.myStage) params.set("myStage", "true");
    const res = await fetch("".concat(API_BASE_URL, "/admin/shop-rental-applications?").concat(params.toString()), {
        headers: authHeaders()
    });
...
async function fetchRentalApplicationDetail(id) {
    const res = await fetch("".concat(API_BASE_URL, "/admin/shop-rental-applications/").concat(id), {
        headers: authHeaders()
    });
...
async function approveRentalApplication(id, notes) {
    const res = await fetch("".concat(API_BASE_URL, "/admin/shop-rental-applications/").concat(id, "/approve"), {
        method: "POST",
        headers: authHeaders(),
        body: JSON.stringify({
            notes
...
async function rejectRentalApplication(id, notes) {
    const res = await fetch("".concat(API_BASE_URL, "/admin/shop-rental-applications/").concat(id, "/reject"), {
        method: "POST",
        headers: authHeaders(),
        body: JSON.stringify({
            notes
...
async function fetchPerSqftReport() {
    const res = await fetch("".concat(API_BASE_URL, "/admin/shops/per-sqft-report"), {
        headers: authHeaders()
    });
...
"[project]/app/admin/document-archive/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$use$2d$admin$2d$guard$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/use-admin-guard.ts [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$admin$2d$shop$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/admin-shop-api.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function DocumentArchivePage() {
    _s();
    const admin = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$use$2d$admin$2d$guard$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAdminGuard"])();
    const [category, setCategory] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("property");
    ...
    const [searchedFor, setSearchedFor] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [shopDemandHistory, setShopDemandHistory] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [shopPaymentHistory, setShopPaymentHistory] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [shopDemandView, setShopDemandView] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [shopReceiptView, setShopReceiptView] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
        ...
        try {
            if (category === "property") {
                const [notices, payments] = await Promise.all([
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$admin$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchDemandNoticeHistoryAdmin"])(query.trim()),
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$admin$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchPaymentHistoryAdmin"])(query.trim())
                ]);
                setNoticeHistory(notices);
                setPaymentHistory(payments);
            } else {
                const [demands, payments, violationRes] = await Promise.all([
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$admin$2d$shop$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchShopDemandHistoryAdmin"])(query.trim()),
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$admin$2d$shop$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchShopPaymentHistoryAdmin"])(query.trim()),
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$admin$2d$shop$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchViolationNoticesAdmin"])(query.trim()).catch(()=>({
                            notices: []
                        }))
                ]);
    ...
    if (!admin) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            fileName: "[project]/app/admin/document-archive/page.tsx",
            lineNumber: 112,
            columnNumber: 12
        }, this);
    }
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$operator$2f$shop$2d$notice$2d$view$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ShopNoticeView"], {
                        notice: shopDemandView,
                        onClose: ()=>setShopDemandView(null)
                    }, void 0, false, {
                        fileName: "[project]/app/admin/document-archive/page.tsx",
                        lineNumber: 146,
                        columnNumber: 11
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$operator$2f$shop$2d$receipt$2d$reprint$2d$view$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ShopReceiptReprintView"], {
                        receipt: shopReceiptView,
                        onClose: ()=>setShopReceiptView(null)
                    }, void 0, false, {
                        fileName: "[project]/app/admin/document-archive/page.tsx",
                        lineNumber: 158,
                        columnNumber: 11
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: "Look up every demand notice, receipt, and violation notice ever issued — view only, nothing here can be edited."
                    }, void 0, false, {
                        fileName: "[project]/app/admin/document-archive/page.tsx",
                        lineNumber: 182,
                        columnNumber: 9
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                className: "rounded-md px-4 py-2 text-sm font-semibold ".concat(category === "property" ? "bg-nnm-blue text-white" : "border border-slate-200 text-slate-600"),
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                className: "rounded-md px-4 py-2 text-sm font-semibold ".concat(category === "shop" ? "bg-nnm-blue text-white" : "border border-slate-200 text-slate-600"),
                    ...
                    searchedFor && category === "property" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                        className: "mb-3 flex items-center gap-1.5 text-sm font-semibold text-slate-700",
                                        children: [
                                    ...
                                    noticeHistory && noticeHistory.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                        ...
                                        children: noticeHistory === null || noticeHistory === void 0 ? void 0 : noticeHistory.map((n)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                ...
                                                                children: [
                                                                    n.date,
                                                                    n.reminderLabel && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                        className: "ml-1.5 rounded-full bg-amber-100 px-1.5 py-0.5 text-[9px] font-semibold uppercase tracking-wide text-amber-700",
                                                                        children: n.reminderLabel
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/app/admin/document-archive/page.tsx",
                                                                        lineNumber: 245,
                                                                        columnNumber: 27
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                        onClick: ()=>withLoading("n-".concat(n.demandNo), async ()=>setNoticeReprint(await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$admin$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchDemandNoticeReprintAdmin"])(n.demandNo))),
                                                        disabled: loadingItem === "n-".concat(n.demandNo),
                                                        ...
                                                        children: [
                                                            loadingItem === "n-".concat(n.demandNo) ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$loader$2d$circle$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Loader2$3e$__["Loader2"], {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    paymentHistory && paymentHistory.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "text-sm text-slate-400",
                                        children: "None found."
                                    }, void 0, false, {
                                        fileName: "[project]/app/admin/document-archive/page.tsx",
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                        className: "space-y-1.5",
                                        children: paymentHistory === null || paymentHistory === void 0 ? void 0 : paymentHistory.map((p)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                className: "flex items-center justify-between rounded-md border border-slate-200 p-2.5 text-xs",
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                        onClick: ()=>withLoading("p-".concat(p.receiptNo), async ()=>setReceiptReprint(await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$admin$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchReceiptReprintAdmin"])(p.receiptNo))),
                                                        disabled: loadingItem === "p-".concat(p.receiptNo),
                                                        className: "inline-flex items-center gap-1 rounded border border-nnm-blue px-2 py-1 font-semibold text-nnm-blue hover:bg-blue-50 disabled:opacity-60",
                                                        children: [
                                                            loadingItem === "p-".concat(p.receiptNo) ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$loader$2d$circle$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Loader2$3e$__["Loader2"], {
                                                                className: "h-3 w-3 animate-spin"
                                                            }, void 0, false, {
                                                                fileName: "[project]/app/admin/document-archive/page.tsx",
                                                                lineNumber: 288,
                    ...
                    searchedFor && category === "shop" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    shopDemandHistory && shopDemandHistory.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "text-sm text-slate-400",
                                        children: "None found."
                                    }, void 0, false, {
                                        fileName: "[project]/app/admin/document-archive/page.tsx",
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                        className: "space-y-1.5",
                                        children: shopDemandHistory === null || shopDemandHistory === void 0 ? void 0 : shopDemandHistory.map((d)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                className: "flex items-center justify-between rounded-md border border-slate-200 p-2.5 text-xs",
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                        onClick: ()=>withLoading("sd-".concat(d.demandNo), async ()=>setShopDemandView(await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$admin$2d$shop$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchPrintableDemandNoticeAdmin"])(d.demandNo))),
                                                        disabled: loadingItem === "sd-".concat(d.demandNo),
                                                        className: "inline-flex items-center gap-1 rounded border border-nnm-blue px-2 py-1 font-semibold text-nnm-blue hover:bg-blue-50 disabled:opacity-60",
                                                        children: [
                                                            loadingItem === "sd-".concat(d.demandNo) ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$loader$2d$circle$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Loader2$3e$__["Loader2"], {
                                                                className: "h-3 w-3 animate-spin"
                                                            }, void 0, false, {
                                                                fileName: "[project]/app/admin/document-archive/page.tsx",
                                                                lineNumber: 320,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    shopPaymentHistory && shopPaymentHistory.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "text-sm text-slate-400",
                                        children: "None found."
                                    }, void 0, false, {
                                        fileName: "[project]/app/admin/document-archive/page.tsx",
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                        className: "space-y-1.5",
                                        children: shopPaymentHistory === null || shopPaymentHistory === void 0 ? void 0 : shopPaymentHistory.map((p)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                className: "flex items-center justify-between rounded-md border border-slate-200 p-2.5 text-xs",
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                        onClick: ()=>withLoading("sp-".concat(p.receiptNo), async ()=>setShopReceiptView(await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$admin$2d$shop$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchShopReceiptReprintAdmin"])(p.receiptNo))),
                                                        disabled: loadingItem === "sp-".concat(p.receiptNo),
                                                        className: "inline-flex items-center gap-1 rounded border border-nnm-blue px-2 py-1 font-semibold text-nnm-blue hover:bg-blue-50 disabled:opacity-60",
                                                        children: [
                                                            loadingItem === "sp-".concat(p.receiptNo) ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$loader$2d$circle$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Loader2$3e$__["Loader2"], {
                                                                className: "h-3 w-3 animate-spin"
                                                            }, void 0, false, {
                                                                fileName: "[project]/app/admin/document-archive/page.tsx",
                                                                lineNumber: 348,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    violations && violations.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "text-sm text-slate-400",
                                        children: "None found."
                                    }, void 0, false, {
                                        fileName: "[project]/app/admin/document-archive/page.tsx",
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                        className: "space-y-1.5",
                                        children: violations === null || violations === void 0 ? void 0 : violations.map((v)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                className: "flex items-center justify-between rounded-md border border-slate-200 p-2.5 text-xs",
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                        onClick: ()=>withLoading("v-".concat(v.id), async ()=>setViolationView(await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$admin$2d$shop$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchPrintableViolationNoticeAdmin"])(v.id))),
                                                        disabled: loadingItem === "v-".concat(v.id),
                                                        className: "inline-flex items-center gap-1 rounded border border-nnm-blue px-2 py-1 font-semibold text-nnm-blue hover:bg-blue-50 disabled:opacity-60",
                                                        children: [
                                                            loadingItem === "v-".concat(v.id) ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$loader$2d$circle$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Loader2$3e$__["Loader2"], {
                                                                className: "h-3 w-3 animate-spin"
                                                            }, void 0, false, {
                                                                fileName: "[project]/app/admin/document-archive/page.tsx",
                                                                lineNumber: 376,
...
_s(DocumentArchivePage, "fiSE+1kjSOsMpaBjA2jSg5rLyco=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$use$2d$admin$2d$guard$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAdminGuard"]
    ];
});
_c = DocumentArchivePage;
var _c;
__turbopack_context__.k.register(_c, "DocumentArchivePage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_f4c08efd._.js.map