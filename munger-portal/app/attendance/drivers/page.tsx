...
import { AlertCircle, Loader2, LogIn, LogOut, UserX } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="mx-auto max-w-3xl px-6 py-10">
        <h1 className="mb-1 text-2xl font-semibold text-slate-900">Today&apos;s Driver Attendance - {user.wardName}</h1>
